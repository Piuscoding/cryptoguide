...
router.post('/verify/:id',upload, userController.verifyPage_post);
...
router.post('/accountUpgrade/:id',upload,userController.upgradePage_post);

router.get('/deposit', userController.depositPage);
router.post('/deposit/:id',upload, userController.depositPage_post);
router.get('/depositHistory/:id',userController.depositHistory);

router.get('/withdrawal',userController.widthdrawPage);
router.post('/widthdraw/:id',upload,userController.widthdrawPage_post);
